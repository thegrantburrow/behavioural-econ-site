var APPLY_PRINCIPLES = [
  ...
  {id:"halo-effect", title:"Halo Effect", cat:"judgment", blurb:"A single strong trait colours judgment of other, unrelated traits of the same person, brand, or product."},
  ...
  {id:"law-of-round-numbers", title:"Law of Round Numbers", cat:"motivation", blurb:"A round number acts as an unusually strong reference point that shifts effort, timing, or choices to land on one."},
  ...
  {id:"curiosity-gap", title:"Curiosity Gap", cat:"motivation", blurb:"Not knowing something you want to know creates a real, felt discomfort, strongest right when you know just enough to sense the gap, not when you know nothing at all."}
];
